...
/*
 * This is a PID class to be used in PID control loops. After instantiating an object, we can call the 
 * public functions to configure settings, send input, and recieve an output. The object is created with
 * default settings for many parameters.
 */
